 ...
 * @author desbenn
 */
@FacesValidator("businessEntityListValidator")
public class BusinessEntityListValidator implements Validator {

    @Override
    public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {

        ArrayList<BusinessEntity> entities = (ArrayList<BusinessEntity>) value;
        if (entities != null) {
            if (entities.isEmpty()) {
    ...
    private FacesMessage getMessage(String componentId) {
        switch (componentId) {
            ...
            case "inspectors":
                return new FacesMessage(FacesMessage.SEVERITY_ERROR, "Invalid Inspector", "At least one inspector is required.");
            default:
